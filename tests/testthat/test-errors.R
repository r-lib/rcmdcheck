test_that("error is thrown as needed, with the correct type", {
  ...
  expect_error_classes(
    capture_output(handle_error_on(err1, "note")),
    class = c("rcmdcheck_error", "rcmdcheck_failure")
  )
  expect_error_classes(
    capture_output(handle_error_on(err1, "warning")),
    class = c("rcmdcheck_error", "rcmdcheck_failure")
  )
  expect_error_classes(
    capture_output(handle_error_on(err1, "error")),
    class = c("rcmdcheck_error", "rcmdcheck_failure")
  )
  expect_error_classes(
    capture_output(handle_error_on(err2, "note")),
    class = c("rcmdcheck_error", "rcmdcheck_warning")
  )
  expect_error_classes(
    capture_output(handle_error_on(err2, "warning")),
    class = c("rcmdcheck_error", "rcmdcheck_warning")
  )
  expect_error_classes(
    capture_output(handle_error_on(err2, "error")),
    class = c("rcmdcheck_error", "rcmdcheck_warning")
  )
  expect_error_classes(
    capture_output(handle_error_on(err3, "note")),
    class = c("rcmdcheck_error", "rcmdcheck_warning", "rcmdcheck_note")
  )
  expect_error_classes(
    capture_output(handle_error_on(err3, "warning")),
    class = c("rcmdcheck_error", "rcmdcheck_warning", "rcmdcheck_note")
  )
  expect_error_classes(
    capture_output(handle_error_on(err3, "error")),
    class = c("rcmdcheck_error", "rcmdcheck_warning", "rcmdcheck_note")
  )

  expect_error_classes(
    capture_output(handle_error_on(wrn1, "note")),
    class = "rcmdcheck_warning"
  )
  expect_error_classes(
    capture_output(handle_error_on(wrn1, "warning")),
    class = "rcmdcheck_warning"
  )
  expect_silent(handle_error_on(wrn1, "error"))
  expect_error_classes(
    capture_output(handle_error_on(wrn2, "note")),
    class = c("rcmdcheck_warning", "rcmdcheck_note")
  )
  expect_error_classes(
    capture_output(handle_error_on(wrn2, "warning")),
    class = c("rcmdcheck_warning", "rcmdcheck_note")
  )
  expect_silent(handle_error_on(wrn2, "error"))

  expect_error_classes(
    capture_output(handle_error_on(nte1, "note")),
